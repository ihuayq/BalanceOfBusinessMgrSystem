...
- (id)initWithFrame:(CGRect)frame leftUIImage:(UIImage *)leftUIImage titleText:(NSString*) titleText numText:(NSString*) numText
{
    ...
    if (self) {
        _imageLeftView  = [[UIImageView alloc]  initWithFrame:CGRectMake(0, 0, leftUIImage.size.width, leftUIImage.size.height)];
        ...
        _numLabel.font = [UIFont boldSystemFontOfSize:18.0f];

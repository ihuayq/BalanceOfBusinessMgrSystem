...
//    [self.view addSubview:noteLabel];
    ...
    BTLabel *label;
    label = [[BTLabel alloc] initWithFrame:CGRectMake(20,cardNumberLabel.frame.size.height + cardNumberLabel.frame.origin.y + 20 , MainWidth- 20*2,3*40) edgeInsets:UIEdgeInsetsMake(10, 10, 10, 10)];
    label.font = [UIFont systemFontOfSize:18];
    label.text = [NSString stringWithFormat:@"提现金额将会转入商户账户,自动结算,15点之前当天到账，15点之后T+1日到账 !"];

...
{
    if ([[NSUserDefaults standardUserDefaults ]objectForKey:@"imei"])
    {
        return [[NSUserDefaults standardUserDefaults ]objectForKey:@"imei"];
    }
    
    NSString *macaddress = [[UIDevice currentDevice] macaddress];//无效
    NSLog(@"macaddress-----------%@",macaddress);
    NSString *uniqueIdentifier = [macaddress stringFromMD5];
    [[NSUserDefaults standardUserDefaults]setObject:uniqueIdentifier forKey:@"imei"];
